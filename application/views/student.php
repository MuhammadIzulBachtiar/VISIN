  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      // bar chart
        ...
        bar_data.addColumn('string', 'Topping');
        bar_data.addColumn('number', 'Jumlah Siswa');
        bar_data.addRows(JSON.parse(BarChartData));

        // Set chart options
        var bar_options = {'title':'<?php echo $BarChartTitle;?>',
                       'width':0,
                       'height':0};

        // Instantiate and draw our chart, passing in some options.
        var bar_chart = new google.visualization.ColumnChart(document.getElementById('chart_bar'));
